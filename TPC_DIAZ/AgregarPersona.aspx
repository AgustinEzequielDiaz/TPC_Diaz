<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarPersona.aspx.cs" Inherits="TPC_DIAZ.AgregarPersona" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="ButtonAgregarPersona" runat="server" Text="Continuar" OnClick="ButtonAgregarPersona_Click" />
